...
```{r}
ggplot(data = candy_rankings_new, mapping = aes(x = price_sugar_index, y = winpercent, color = fruity == TRUE)) +
  facet_grid(. ~ bar) +
  geom_point() +
...
9 - using piping (and then) to create tables and filta data that helps us to analyze candy data. 
